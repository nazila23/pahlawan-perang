    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main2.anggota')),
                ('no_panggil', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main2.exemplar')),
            ],
        ),
    ]
